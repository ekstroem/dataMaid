...
\proglang{R}-packages such as \pkg{data.table}, and \pkg{plyr} have
...
user's needs. The most common arguments are summarized in Table~\ref{}
but in order to understand this distinction, a brief glimpse of the
inner structure of \R{clean()} might be useful. This can be obtained
from Figure~\ref{figure:cleanStructure}.
