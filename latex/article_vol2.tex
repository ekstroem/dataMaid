...
\end{Soutput}
\end{Schunk}
and we find that only the final variable, \R{var6}, for which all
...
an online \pkg{shiny} application where user that are not
...
\section{Appendix B: User-extended cleaning of
  testData} \label{sec:appendix2}
\includepdf[pages=2-, pagecommand={}, frame=true, noautoscale=true, scale=0.7]{cleanR_testData.pdf}
