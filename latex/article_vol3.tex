...
$numeric
[1] "variableType" "countMissing" "uniqueValues" "centralValue" "quartiles"   
[6] "minMax"      
...
$Date
[1] "variableType" "countMissing" "uniqueValues" "centralValue" "minMax"      
[6] "quartiles" 
\end{Soutput}
\end{Schunk} %$
...
\begin{Schunk}
\begin{Sinput}
R> makeDataReport(toyData, onlyProblematic = TRUE, mode = "check")
\end{Sinput}
\end{Schunk}
